<?php namespace Cubecamp\ContentEditor\Models;
...
class Settings extends Model
{
    ...
    public $settingsCode = 'cubecamp_contenteditor_settings';

    public $settingsFields = 'fields.yaml';

    const CACHE_KEY = 'cubecamp:contenteditor.additional_styles';

    public function initSettingsData()
    {
        $this->additional_styles = File::get(plugins_path() . '/cubecamp/contenteditor/assets/additional-css.css');
    }
